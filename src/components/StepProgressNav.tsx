...
export const StepProgressNav: React.FC<StepProgressNavProps> = ({
  ...
  const steps: {
  ...
  }[] = [
    {
      ...
      subtitle: candidateName || 'Upload Existing or Build Blank',
    ...
    },
    {
      part: 2,
      number: '2',
      title: 'Part 2: Job Match (Optional)',
      subtitle: hasJobDescription ? `Loaded (${matchScore}% match)` : 'Match a Job or Skip to Export',
    ...
    },
    {
      part: 3,
      number: '3',
      title: hasJobDescription ? 'Part 3: Optimize & Export' : 'Part 3: ATS Format & Export',
      subtitle: hasJobDescription 
        ? `ATS ${atsScore}% • ${matchScore}% Match • DOCX & PDF` 
        : `ATS ${atsScore}% • Direct Single-Column Export`,
